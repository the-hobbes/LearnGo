...
func productInGivenDirection() {
	// calculate the product of the 4 numbers in the given direction
	return
}
...
func main() {
	// create composite literal data structure, 20x20 array of arrays.
	// The notation ... specifies an array length equal to the maximum element 
	// index plus one.
	grid := [20][20]int{ 
